...
* ![](/assets/stion_xinxi.png) : 单击此图标可查看通知事件日志工具窗口中的说明.或者,当该图标是空的没有新的通知.

* ![](/assets/sticon_error.png) : 这闪烁的图标,指示已经发生了IDE内部错误.单击以查看错误说明和提交报告.

* ![](/assets/sticon_neicun.png) : 显示当前的堆水平和内存使用情况.默认情况下,它不是显示.单击内存指示器运行垃圾回收器.
